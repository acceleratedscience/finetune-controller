...
from app.schemas.db_schemas import DatasetTypes
...
async def upload_dataset_url(job: JobInput, url: str):
...
async def stream_dataset_url(job: JobInput, url: str, description: str):
